...
<html>
<head>
	<title>Cart-Destiny HealthCare</title>
...
<td><img src="<?= $row['medicine_image'] ?>" width="50">
</td>
<td><?= $row['medicine_name']?></td>
<td><i class="fas fa-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($row['medicine_price'],2); ?></td>
...
<td><a href="action.php?remove=<?= $row['id']?>" class="text-danger lead" onclick="return confirm('Are you sure you want to remove this item?')"><i class="fas fa-trash-alt"></i></td>
                 	</tr>
                 ...
                 <tr>
                 	...
                 	<td><a href="checkout.php" class="btn btn-info <?= ($grand_total>1)?"":"disabled"?>"><i class="fas fa-credit-card"></i>&nbsp;&nbsp;Checkout</a></td>
                 	</tr>
                 </tbody>
				</table>
			</div>
...
$(".itemQty").on('change',function(){
 var $el = $(this).closest('tr');
  var mid=$el.find(".mid").val();
 var mprice=$el.find(".mprice").val();
...
method:'post',
cache:false,
data:{qty:qty,mid:mid,mprice:mprice},
